            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.03)] space-y-6">
                ...
                >
                    ...
                    <div className="flex justify-end">
                        ...
                        <button
                            type="submit"
                            className="px-5 py-2 rounded-xl bg-zinc-950 hover:bg-zinc-800 dark:bg-zinc-50 dark:hover:bg-zinc-200 text-white dark:text-zinc-950 font-medium text-xs tracking-wide transition-colors shadow-sm cursor-pointer"
                        >
                            Post Comment
                        </button>
                    </div>
